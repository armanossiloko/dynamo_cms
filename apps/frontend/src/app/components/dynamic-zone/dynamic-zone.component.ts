...
@Component({
  ...
  template: `
    <div class="dynamic-zone border border-border-primary rounded-2xl p-5 font-body">
      ...
      <div *ngIf="instances().length === 0" class="text-center py-12 text-text-muted">
          ...
          <div class="p-5 overflow-y-auto max-h-[60vh]">
            <div *ngFor="let category of categories()" class="mb-5">
              ...
              <div class="grid grid-cols-2 gap-2">
                <button
                  *ngFor="let component of getComponentsByCategory(category.name)"
...
export class DynamicZoneComponent implements OnInit {
